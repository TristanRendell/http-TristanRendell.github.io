...
(function($){ 
	...
	$.fn.splitText = function(options){
		...
		function splitWords(userInput, justSplit){
			// the replace ensures newlines are preserved as elements in the array
			  var a = userInput.replace(/\n/g, ' \n ').split(" ");
			   ...
			   // need to wrap breaks in a div. This is more complicated than
			   // the what the original script does.
			   // '\n' is being used as a flag- should this element be wrapped in a word-measure div?
			   $.each(a, function(i,val){
			  		if(val.match(/\n/)) {
